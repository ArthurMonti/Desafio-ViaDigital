...
namespace APICore.Controllers
{
    ...
    public class ContainersController : ControllerBase
    {
        ...
        public ContainersController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Container>>> GetContainers(int UserId)
        {
            try
            {
                return await _context.Container.Where(e => e.IDUser == UserId).ToListAsync();
